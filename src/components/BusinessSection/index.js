        ...
        <div className="w-full flex max-w-[1440px]">
            <div className="w-1/2 p-8">
                <div className="flex gap-[12px] text-sm">
                    ...
                    <p className="font-bold text-[80px] leading-[92px]">Fresha for Business</p>
                    <p className="text-2xl mb-6">Supercharge your business for free with the world's top booking platform for salons and spas. Independently voted no. 1 by industry professionals.</p>
                    <button className="text-white bg-black rounded-3xl border border-[#bfbfbf] h-[48px] px-5" >
                    Find out more
                    </button>
            </div>
            <img className="w-2/4 asssss rounded-3xl " src="https://w10.naukri.com/mailers/2021/naukri-learning/oct/27oct-v2/What-is-Web-Developer.jpg"/>
        </div>
    )
} 